...
const AdminDashboard = () => {
  ...
  const handleCreditDebit = async () => {
    ...
    await supabase.from('transactions').insert({
      ...
      recipient_name: cdType === 'credit' ? 'Credit Payment' : 'Debit Payment',
      amount,
      description: cdDescription || (cdType === 'credit' ? 'Credit payment' : 'Debit payment'),
              ...
              <Card className="bg-gray-800 border-amber-500/50 border-2">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="pt-3 border-t border-gray-700 space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      {language === 'vi'
                        ? 'Áp dụng riêng cho từng phương thức chuyển tiền.'
